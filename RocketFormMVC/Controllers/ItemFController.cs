...
using DotNetNuke.Web.Mvc.Framework.ActionFilters;
using DotNetNuke.Web.Mvc.Framework.Controllers;
using Nevoweb.RocketFormMVC.PageContext;
...
{
    [DnnHandleError]
    public class ItemFController : DnnController
    {
        ...
        protected override void Initialize(RequestContext requestContext)
        {
            ...
            var strHeader2 = RocketFormsUtils.DisplayView(_portalId, _systemkey, _moduleRef, "", _sessionParam, "viewlastheader.cshtml");
        ...
        {
            var strOut = RocketFormsUtils.DisplayView(_portalId, _systemkey, _moduleRef, "", _sessionParam, "view.cshtml", "loadsettings");
            if (strOut == "loadsettings")
            {
                strOut = RocketFormsUtils.DisplaySystemView(_portalId, _moduleRef, _sessionParam, "ModuleSettingsMsg.cshtml");
                string[] parameters;
            ...
            if (_hasEditAccess)
            {
                ...
                if (viewButtonsOut == null)
                {
                    ...
                    viewButtonsOut = RocketFormsUtils.DisplaySystemView(_portalId, _moduleRef, _sessionParam, "ViewEditButtons.cshtml", true);
